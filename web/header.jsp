...
<body>
    ...
    <div class="row u-max-full-width" style="background-color: #ea0b2a; padding: 10px 22px 0px 22px">
        <img class="u-pull-left" src="https://www.banorte.com/cms/redes_sociales/Banorte.jpg" width="180px"
            height="110px">
        ...
        <div class="u-pull-right" style="text-align: end;">
            <h4 style="text-align: right; color: white;">Bienvenido <%=session.getAttribute("usuario")%></h1>
